...
//import cn.wpin.mall.portal.entity.*;
...
//
//
//    public CommonResult generateOrder(OrderParam orderParam,Member currentMember) {
...
//        } else {
//            //使用优惠券
//            CouponHistoryDetail couponHistoryDetail = getUseCoupon(cartPromotionItemList, orderParam.getCouponId());
...
//        //收货人信息：姓名、电话、邮编、地址
//        MemberReceiveAddress address = memberReceiveAddressService.getItem(orderParam.getMemberReceiveAddressId());
...
//                Member member = memberService.getById(timeOutOrder.getMemberId());
...
//                Member member = memberService.getById(cancelOrder.getMemberId());
...
//        //根据积分使用规则判断是否可用
//        //是否可与优惠券共用
//        IntegrationConsumeSetting integrationConsumeSetting = integrationConsumeSettingMapper.selectByPrimaryKey(1L);
...
//     */
//    private CouponHistoryDetail getUseCoupon(List<CartPromotionItem> cartPromotionItemList, Long couponId) {
//        List<CouponHistoryDetail> couponHistoryDetailList = memberCouponService.listCart(cartPromotionItemList, 1);
...
//        for (CartPromotionItem cartPromotionItem : cartPromotionItemList) {
//            SkuStock skuStock = skuStockMapper.selectByPrimaryKey(cartPromotionItem.getProductSkuId());
